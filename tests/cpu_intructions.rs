...
fn call_ret() {
    // call_ret_test.S
    let code = vec![
        0x21, 0x55, 0xAA, 0xC3, 0x0C, 0x00, 0x06, 0x00, 0xC9, 0x06, 0xFF, 0xC9, 0x06, 0xFF, 0xCD,
        0x06, 0x00, 0x70, 0xAF, 0x06, 0xFF, 0xCC, 0x06, 0x00, 0x70, 0x06, 0x00, 0xC4, 0x09, 0x00,
        0x70, 0x3C, 0x06, 0x00, 0xCC, 0x09, 0x00, 0x70, 0x06, 0xFF, 0xC4, 0x06, 0x00, 0x70, 0x37,
        0x06, 0xFF, 0xDC, 0x06, 0x00, 0x70, 0x06, 0x00, 0xD4, 0x09, 0x00, 0x70, 0x3F, 0x06, 0x00,
        0xCC, 0x09, 0x00, 0x70, 0x06, 0xFF, 0xC4, 0x06, 0x00, 0x70,
    ];

    let tester = InstructionTest::new(Cpu::default(), code, 0);

    assert!(tester.run(Some(1000)).all(|d| {
        match d {
            Ok((_, d)) => d == 0,
            Err(InstructionTestError::MaxCyclesReached) => panic!(),
            _ => true,
...
fn jr() {
    // jr_test.S
    let code = vec![
        0x21, 0x55, 0xAA, 0xAF, 0x06, 0x00, 0x28, 0x02, 0x06, 0xFF, 0x70, 0xF6, 0xFF, 0x06, 0xFF, 
        0x28, 0x02, 0x06, 0x00, 0x70, 0xAF, 0x06, 0xFF, 0x20, 0x02, 0x06, 0x00, 0x70, 0xF6, 0xFF, 
        0x06, 0x00, 0x20, 0x02, 0x06, 0xFF, 0x70, 0x37, 0x06, 0x00, 0x38, 0x02, 0x06, 0xFF, 0x70, 
        0x37, 0x3F, 0x06, 0xFF, 0x38, 0x02, 0x06, 0x00, 0x70, 0x37, 0x06, 0xFF, 0x30, 0x02, 0x06, 
        0x00, 0x70, 0x37, 0x3F, 0x06, 0x00, 0x30, 0x02, 0x06, 0xFF, 0x70, 0xC3, 0xAF, 0x00, 0x00, 
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x4E, 0x06, 0x20, 0x70, 
        0x18, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x06, 0x10, 0x70, 0x18, 0xAD,
    ];
